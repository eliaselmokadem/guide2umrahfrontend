...
const Umrah: React.FC = () => {
  ...
  return (
    <>
      <SEO 
        title="Guide2Umrah - Alles over de Umrah"
        description="Ontdek alles over de Umrah rituelen, voorschriften en praktische informatie. Leer stap voor stap hoe je de Umrah correct uitvoert."
      />
      <div>
        <Navbar />
