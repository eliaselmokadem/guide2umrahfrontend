...
const LogoBanner: React.FC = () => {
  return (
    <div className="w-full bg-white/5 py-4 md:py-8 overflow-hidden">
      <div className="flex animate-scroll whitespace-nowrap">
        {/* First set of logos */}
        <div className="flex min-w-max space-x-24 md:space-x-40 mx-12 md:mx-20">
          <div className="w-20 md:w-32 flex-shrink-0">
            <img src={umrah2gopng} alt="Umrah2Go" className="h-8 md:h-12 object-contain" />
          </div>
          <div className="w-20 md:w-32 flex-shrink-0">
            <img src={safarcompng} alt="Safarcom" className="h-8 md:h-12 object-contain" />
          </div>
          <div className="w-20 md:w-32 flex-shrink-0">
            <img src={jeddahflightspng} alt="Jeddah Flights" className="h-8 md:h-12 object-contain" />
          </div>
        </div>
