      ...
      <style>
        {`
          ...
          @keyframes circleGlow {
            0% {
              filter: 
                drop-shadow(6px 0 12px rgba(37,211,102,0.8))
                drop-shadow(12px 0 16px rgba(37,211,102,0.6))
                drop-shadow(3px 0 20px rgba(37,211,102,0.4));
            }
            25% {
              filter: 
                drop-shadow(0 6px 12px rgba(37,211,102,0.8))
                drop-shadow(0 12px 16px rgba(37,211,102,0.6))
                drop-shadow(0 3px 20px rgba(37,211,102,0.4));
            }
            50% {
              filter: 
                drop-shadow(-6px 0 12px rgba(37,211,102,0.8))
          ...
          .phone-icon {
            animation: phoneRotate 8s infinite linear;
            transform-origin: center;
          }

          .circle-glow {
            animation: circleGlow 4s infinite linear;
          }
        `}
      </style>
      <a
        ...
        className="fixed bottom-6 right-6 bg-[#25D366] text-white p-3 rounded-full shadow-lg hover:bg-[#128C7E] transition-all duration-300 transform hover:scale-110 z-50 flex items-center justify-center"
